package husacct.define.task.applogic.view;

import husacct.define.domain.DefineDomainServiceOld2011;
import husacct.define.task.applogic.view.jpanel.DefinitionJPanel;
import husacct.define.task.applogic.view.utils.JPanelStatus;
...
public class ApplicationJFrame extends javax.swing.JFrame {
	...
	private void initUi() {
		try {
			...
			setIconImage(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/jframeicon.jpg")).getImage());
			{
			...
			}
			{
				...
				setJMenuBar(jMenuBar);
				{
					...
					jMenu1.setText("Architecture");
					{
						...
						jMenuItemNewArchitecture.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/new.png")));
					...
					}
					{
						...
						jMenuItemOpenArchitecture.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/open.png")));
					...
					}
					{
						...
						jMenuItemSaveArchitecture.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/save.png")));
					...
					}
					{
						...
						jMenuItemExit.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/exit.png")));
					}
				}
				{
					jMenu2 = new JMenu();
					...
					jMenu2.setText("Analyse");
					{
						...
						jMenuItemStartAnalyse.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/analyse.png")));
					...
					}
					{
						...
						jMenuItemCheckDependencies.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/analyse.png")));
				...
				}
				{
					...
					jMenu3.setText("Help");
					{
						...
						jMenuItemAbout.setIcon(new ImageIcon(getClass().getClassLoader().getResource("husacct/define/task/resources/about.png")));
